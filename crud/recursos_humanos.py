...
def crear_contrato(db: Session, contrato: schemas.contrato.ContratoCreate, empresa_id: int):
    ...
    try:
        ...
        db_contrato = Contrato(
            ...
            proporciona_alojamiento=contrato.proporciona_alojamiento,
            direccion_alojamiento=contrato.direccion_alojamiento,
            dias_jornada=contrato.dias_jornada,
            hora_inicio=contrato.hora_inicio,
            hora_fin=contrato.hora_fin,
            pausa_alimenticia_inicio=contrato.pausa_alimenticia_inicio,
            pausa_alimenticia_fin=contrato.pausa_alimenticia_fin,
            horas_semanales=contrato.horas_semanales,
            medio_pago=contrato.medio_pago,
            lugar_pago=contrato.lugar_pago,
            herramientas_entregadas=contrato.herramientas_entregadas,
            lugar_entrega_herramientas=contrato.lugar_entrega_herramientas,
            lugar_trabajo_direccion=contrato.lugar_trabajo_direccion,
            lugar_trabajo_distrito=contrato.lugar_trabajo_distrito,
            lugar_trabajo_municipio=contrato.lugar_trabajo_municipio,
            lugar_trabajo_departamento=contrato.lugar_trabajo_departamento,
            distrito_celebracion=contrato.distrito_celebracion,
